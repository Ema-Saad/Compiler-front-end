...
Assignment = returnable_namedtuple('Assign', 'ident expr')
Attribute = returnable_namedtuple('Attr', 'ident type expr')
BinaryOperation = returnable_namedtuple('BinaryOpr', 'operator left right')
...
FunctionCall = returnable_namedtuple('FuncCall', 'ident params')
Ident = returnable_namedtuple('Ident', 'name')
If = returnable_namedtuple('If', 'condition true false')
Let = returnable_namedtuple('Let', 'assign expr')
